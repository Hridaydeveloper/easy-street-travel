...
const SearchOptions: React.FC = () => {
  ...
  return <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
      {searchOptions.map((option, index) => <Card key={index} className="bg-gray-800 border-gray-700 hover:bg-gray-700 transition-colors cursor-pointer">
          <CardContent className="p-6 text-center">
            ...
            <Button onClick={option.action} variant="outline" className="w-full border-gray-600 hover:bg-gray-600 text-slate-100">
              Explore
            </Button>
          </CardContent>
        </Card>)}
